(function () {
    ...
    function calculateCodePaneTranslateY(barHeight, num) {
        return ((num - 1) * -barHeight);
    }

    function calculateCodeBarTranslateY(barHeight, num) {
        return ((num - 3) * barHeight);
    }
    ...
    EventLoopAnimation.prototype.moveToLineCodePan = function () {
        this._moveToLineCodePan = true;
        return this;
    };

    EventLoopAnimation.prototype.moveToLineBarPan = function () {
        this._moveToLineCodePan = false;
        return this;
    };
    ...
    EventLoopAnimation.prototype.pushTask = function (activated) {
        return this.action(function (animate) {
            ...
            if (activated) {
                newTask.style.backgroundColor = ACTIVE_COLOR;
            }
    ...
    EventLoopAnimation.prototype.pushStack = function (text) {
        return this.action(function (animate) {
            ...
            div.style.backgroundColor = ACTIVE_COLOR;
            const lastChild = this._jsStack.lastElementChild;
            if (lastChild && lastChild.style.getPropertyValue('background-color')){
                lastChild.style.removeProperty('background-color');
            }
    ...
    EventLoopAnimation.prototype.popStack = function (text) {
        return this.action(function (animate) {
            const lastActiveChild = this._jsStack.children[this._jsStack.children.length - 2];
            var div = this._jsStack.children[this._jsStack.children.length - 1];

            if (lastActiveChild) {
                lastActiveChild.style.setProperty('background-color', ACTIVE_COLOR);
            }
            return transition(div, {
                opacity: 0
    ...
    EventLoopAnimation.prototype.moveToLine = function (num) {
        return this.action(function (animate) {
            ...
            return this._moveToLineCodePan ? this._moveCodePane(barHeight, num, animate) : this._moveCodeBar(barHeight, num, animate);
        }.bind(this));
    };

    EventLoopAnimation.prototype._moveCodePane = function (barHeight, num, animate) {
        return transition(this._codePane, {
                transform: 'translateY(' + calculateCodePaneTranslateY(barHeight, num) + 'px)'
            }, 0.3 * animate, 'ease-in-out');
    };

    EventLoopAnimation.prototype._moveCodeBar = function (barHeight, num, animate) {
        return transition(this._codeBar, {
                transform: 'translateY(' + calculateCodeBarTranslateY(barHeight, num) + 'px)'
            }, 0.3 * animate, 'ease-in-out');
    };
    ...
    EventLoopAnimation.prototype.shiftTask = function () {
        return this.action(function (animate) {
            this._tasksRemoved++;
            let offset;
            const offsetEl = this._taskRail.children[this._tasksRemoved];
